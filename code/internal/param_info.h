...
ParamInfo kParams_JIP_OneObjectRef_TwoStrings_OneInt[] =
{
	{"Object Ref", kParamType_ObjectRef, 0},
	{"String", kParamType_String, 0},
	{"String", kParamType_String, 0},
...
ParamInfo kParams_JIP_OneOptionalFloat_OneOptionalString[] =
{
	{"Float", kParamType_Float, 1},
	{"String", kParamType_String, 1}
};
...
ParamInfo kParams_JIP_OneInt_ThreeOptionalFloats_OneOptionalInt[] =
{
	{"Integer", kParamType_Integer, 0},
	{"Float", kParamType_Float, 1},
	{"Float", kParamType_Float, 1},
...
ParamInfo kParams_yUI_OneScriptVariable[] =
{
	{"String", kParamType_ScriptVariable , 0},
};

ParamInfo kParams_yUI_OneString_OneOptionalForm[] =
{
	{"String", kParamType_String, 0},
	{"Form", kParamType_AnyForm, 1},
};