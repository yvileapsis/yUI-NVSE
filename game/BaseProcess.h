...
public:
	...
	virtual void			Unk_34() {};
	virtual void			Unk_35() {};
	virtual void			StopIdle(Actor* actor) {};
	virtual void			Unk_37() {};
	virtual void			Unk_38() {};
	virtual void			Unk_39() {};
	...
	virtual void			Unk_42() {};
	virtual void			Unk_43() {};
	virtual bool			GetCaughtPlayerPickpocketting() { return false; };
	...
	virtual void			Unk_50() {};
	virtual void			Unk_51() {};
	virtual WeaponInfo*		GetWeaponInfo() { return nullptr;  };	// unk0114
	virtual AmmoInfo*		GetAmmoInfo() { return nullptr; };		// unk0118
	virtual void			Unk_54() {};
	virtual void			Unk_55() {};
	virtual void			Unk_56() {};
	virtual void			Unk_57() {};
	...
	virtual void			Unk_5F() {};
	virtual void			Unk_60() {};
	virtual NiNode*			GetProjectileNode() { return nullptr; };
	virtual void			SetProjectileNode(NiNode* node) {};
	virtual void			Unk_63() {};

	virtual NiNode*			GetWeaponBone(void* bipedNames) { return nullptr; };
	virtual void			Unk_65() {};
	virtual void			Unk_66() {};
	virtual void			Unk_67() {};
	virtual void			Unk_68() {};
	...
	virtual void			Unk_6C() {};
	virtual void			Unk_6D() {};
	virtual AnimData*		GetAnimData() { return nullptr;  };
	virtual void			Unk_6F() {};
	virtual void			Unk_70() {};
	virtual void			Unk_71() {};
	virtual void			Unk_72() {};
	...
	virtual void			Unk_9B() {};
	virtual void			Unk_9C() {};
	virtual TESPackageData* GetPackageData() { return nullptr; };
	virtual void			Unk_9E() {};
	virtual TESPackage*		GetCurrentPackage() { return nullptr; };
	virtual UInt32			GetPackageInfo0C() { return 0; };
	virtual void			Unk_A1() {};
	virtual void			Unk_A2() {};
	virtual bhkCharacterController* GetCharacterController() { return nullptr; };
	...
	virtual float			GetDiveBreath() { return 0; };
	virtual void			Unk_C1() {};
	virtual void			Unk_C2() {};
	virtual void			Unk_C3() {};
	virtual void			Unk_C4() {};
	virtual void			Unk_C5() {};
	virtual void			Unk_C6() {};
	virtual bool			GetAlerted() { return false; };
	...
	virtual void			Unk_E1() {};
	virtual void			Unk_E2() {};
	virtual TESIdleForm*	GetIdleForm10C() { return nullptr; };
	...
	virtual void			Unk_F7() {};
	virtual void			Unk_F8() {};
	virtual SInt16			GetCurrentAnimAction() { return 0; };
	virtual BSAnimGroupSequence* GetCurrentSequence() { return nullptr; };
	...
	virtual bool			IsReadyForAnim() { return false; };
	virtual void			Unk_FF() {};
	virtual void			SetIsAiming() {};
	virtual bool			IsAiming() { return false; };
	...
	virtual bool			IsWeaponOut() { return false; };
	...
	virtual int				GetSitSleepState() { return false; };
	...
	virtual DetectionData*	GetDetectionData(Actor* target, UInt32 detecting) { return nullptr; };
	...
	virtual float			GetActorAlpha() { return 0; };
	...
	virtual BSBound*		GetBoundingBox() { return nullptr; };
	...
	virtual UInt32			GetQueuedIdleFlags() { return false; };
	...
	virtual TESIdleForm*	GetQueuedIdleForm() { return nullptr; };
	...
	virtual float			GetLightAmount() { return false; };
	...
	virtual float			GetRadsSec() { return false; };
	virtual ActorHitData*	GetLastHitData() { return nullptr; };
	virtual void			CopyLastHitData(ActorHitData* hitData) {};
	virtual void			ResetLastHitData() {};
	virtual ActorHitData*	GetLastTargetHitData() { return nullptr; };
