...
public:
	...
	virtual void					Unk_05();
	virtual NiPoint3*				Unk_06(NiPoint3&, int);
	virtual void					Unk_07();
	virtual double					Unk_08(int, int);
	...
	virtual void					Unk_F0();
	virtual void					Unk_F1();
	virtual void					GetMagicItem160();
	virtual void					SetMagicItem160();
	virtual void					Unk_F4();
	virtual void					Unk_F5();
	...
	virtual void					SetQueuedIdle(TESIdleForm* idleForm);
