...
void EventLayer()
{
	...
	RegisterEvent("yJAM:JG:OnRender", 0, nullptr, NVSEEventManagerInterface::kFlag_HasUnknownArgTypes);
	...
	RegisterEvent("yJAM:JIP:OnHit", 0, nullptr, NVSEEventManagerInterface::kFlag_HasUnknownArgTypes);
