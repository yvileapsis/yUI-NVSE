...
public:
	...
	bool GetMouseState(int buttonID, KeyState state) { return ThisCall<bool>(0xA23A50, this, buttonID, state); };
	bool SetKeybindIfValid(ControlCode whichBind, OSInputGlobals::Device device, UInt8 scancode) { return ThisCall<bool>(0xA23A50, this, whichBind, device, scancode); };
