...
public:
	...
	virtual void		Unk_E1(bool, float);
	...
	void RestoreActorValue(int avCode, float value) { ThisCall(0x88B740, this, avCode, value); };
	void Kill(Actor* killedBy) { ThisCall(0x89D900, this, killedBy, 0.0F); };
};
...
public:
	...
	UInt8								isPlayingCombatAttackSound;	// 608
	UInt8								gap609[3];				// 609
	...
	void SetActiveQuest(TESQuest* quest) { ThisCall(0x9529D0, this, quest); };
};
